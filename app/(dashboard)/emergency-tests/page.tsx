...
import { BellRing, CalendarDays, CheckSquare, BarChart2, Calendar } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Planification et résultats des exercices et simulations d'urgence"
        icon={BellRing}
      />
